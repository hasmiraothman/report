...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'regno' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2018-08-08 15:08:40',
                'modified' => '2018-08-08 15:08:40'
            ],
        ];
        parent::init();
    }
