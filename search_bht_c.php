...
<h4>Tambah BHT Pesakit Susulan:</h4>
<table>
<tr><td>
<label for="date">Tarikh Census: </label></td>
<td>

<?php
	$ta = "SELECT distinct tarikh_census FROM tbl_census
	ORDER BY id_census DESC limit 1";
...
<table width="90%" border="1" bgcolor="#FFFFFF">
 ...
 <?php
	...
	ORDER BY id_census DESC  limit 20";
			$q = $pdo->prepare($t);
			$q->execute();
