...
<div class="actions small-12 medium-4 large-3 columns">
	<h4>Actions</h4>
	<ul class="no-bullet">
		<li><?= $this->Html->link(__('Add a Task Company', true), ['action' => 'add']); ?></li>
		<li><?= $this->Html->link(__('Edit Task Type', true), ['action' => 'edit', $eventType->id]); ?> </li>
		<li><?= $this->Html->link(__('Delete Task Type', true), ['action' => 'delete', $eventType->id], [], sprintf(__('Are you sure you want to delete %s?', true), $eventType->name)); ?> </li>
		<li><?= $this->Html->link(__('Manage Tasks Types', true), ['action' => 'index']); ?> </li>
